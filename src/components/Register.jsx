...
function Register() {
  ...
  return (
    <form className="bg-[rgba(255,255,255,.07)] w-full sm:w-8/12 md:w-7/12 lg:w-5/12 xl:w-4/12  mx-auto px-10 py-16 shadow-2xl shadow-[rgba(255,255,255,.1)]" onSubmit={onSubmitHandler}>
